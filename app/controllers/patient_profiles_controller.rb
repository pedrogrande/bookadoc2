class PatientProfilesController < ApplicationController
  ...
  def create
    ...
    @patient_profile.user = current_user
  ...
  private
    ...
    def patient_profile_params
      params.require(:patient_profile).permit(:user_id, :first_name, :last_name, :phone, :medicare_number, :address, :suburb, :state, :postcode, :country, :latitude, :longitude)
    end
end
